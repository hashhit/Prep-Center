...
function initAdmin(socket) {
  ...
  var placements = [];
  var markup;
  axios__WEBPACK_IMPORTED_MODULE_2__["default"].get('/admin/placements', {
    headers: {
  ...
  function renderItems(items) {
    ...
    return parsedItems.map(function (orderItem) {
      return "\n                <p>".concat(orderItem.item.name, " - ").concat(orderItem.qty, " pcs </p>\n            ");
    }).join('');
  }
  function generateMarkup(placements) {
    return placements.map(function (placement) {
      return "\n                <tr>\n                <td class=\"border px-4 py-2 text-green-900\">\n                    <p>".concat(placement._id, "</p>\n                    <div>").concat(renderItems(placement.items), "</div>\n                </td>\n                <td class=\"border px-4 py-2\">").concat(placement.customerId.name, "</td>\n                <td class=\"border px-4 py-2\">").concat(placement.address, "</td>\n                <td class=\"border px-4 py-2\">\n                    <div class=\"inline-block relative w-64\">\n                        <form action=\"/admin/order/status\" method=\"POST\">\n                            <input type=\"hidden\" name=\"orderId\" value=\"").concat(placement._id, "\">\n                            <select name=\"status\" onchange=\"this.form.submit()\"\n                                class=\"block appearance-none w-full bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded     \n                                shadow leading-tight focus:outline-none focus:shadow-outline\">\n                                <option value=\"placed\"\n                                    ").concat(placement.status === 'placed' ? 'selected' : '', ">\n                                    Placed</option>\n                                <option value=\"confirmed\" ").concat(placement.status === 'confirmed' ? 'selected' : '', ">\n                                    Confirmed</option>\n                                <option value=\"labelled\" ").concat(placement.status === 'labelled' ? 'selected' : '', ">\n                                    Labelled</option>\n                                <option value=\"sticker_removed\" ").concat(placement.status === 'sticker_removed' ? 'selected' : '', ">\n                                    Sticker Removed\n                                </option>\n                                <option value=\"expiration_labelled\" ").concat(placement.status === 'expiration_labelled' ? 'selected' : '', ">\n                                    Expiration Labelled\n                                </option>\n                                <option value=\"completed\" ").concat(placement.status === 'completed' ? 'selected' : '', ">\n                                    Completed\n                                </option>\n                                <option value=\"shipping_to_courier_service\" ").concat(placement.status === 'shipping_to_courier_service' ? 'selected' : '', ">\n                                    Shipped to courier service\n                                </option>\n                                <option value=\"delivered\" ").concat(placement.status === 'delivered' ? 'selected' : '', ">\n                                    Delivered\n                                </option>\n\n                            </select>\n                        </form>\n                        <div\n                            class=\"pointer-events-none absolute inset-y-0 right-0 flex items-center px-2 text-gray-700\">\n                            <svg class=\"fill-current h-4 w-4\" xmlns=\"http://www.w3.org/2000/svg\"\n                                viewBox=\"0 0 20 20\">\n                                <path\n                                    d=\"M9.293 12.95l.707.707L15.657 8l-1.414-1.414L10 10.828 5.757 6.586 4.343 8z\" />\n                            </svg>\n                        </div>\n                    </div>\n                </td>\n                <td class=\"border px-4 py-2\">\n                    ").concat(moment__WEBPACK_IMPORTED_MODULE_0___default()(placement.createdAt).format('hh:mm A'), "\n                </td>\n            </tr>\n        ");
    }).join('');
  }
  //Socket
...
function updateCart(prep) {
  axios__WEBPACK_IMPORTED_MODULE_3__["default"].post('/update-cart', prep).then(function (res) {
...
addToCart.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    var prep = JSON.parse(btn.dataset.prep);
    updateCart(prep);
  });
});
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkPCT"] = self["webpackChunkPCT"] || [];
